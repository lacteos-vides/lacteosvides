...
export const ProductCard = memo(function ProductCard({
  ...
  return (
    <div
      className="animate-enter-fade-up flex"
      style={{ animationDelay: `${delayMs}ms` }}
    >
      <div
        className="product-card-highlight flex flex-1 items-center justify-between rounded-xl border-2 border-yellow-400/30 bg-white/15 px-6 py-4"
